...
for hand_class in [0, 1, 2, 3, 4, 5]:
    ...
    for i in range(1000):
        if hand_class==0:
            filename = 'hand-learn/img_zero{0:03d}.png'.format(i)
        elif hand_class==1:
            filename = 'hand-learn/img_one{0:03d}.png'.format(i)
        elif hand_class==2:
            filename = 'hand-learn/img_two{0:03d}.png'.format(i)
        elif hand_class==3:
            filename = 'hand-learn/img_three{0:03d}.png'.format(i)
        elif hand_class==4:
            filename = 'hand-learn/img_four{0:03d}.png'.format(i)
        elif hand_class==5:
            filename = 'hand-learn/img_five{0:03d}.png'.format(i)
